...
from mate_models.networks.architecture import ResidualBlock
from mate_models.networks.architecture import SPADE
from mate_models.networks.architecture import PositionalNorm2d
import mate_util.util as util
from mate_models.networks.modules import SelfAttentionLayer, FFNLayer, AdaBlock
...
def dynamic_attention(q, k, q_prune, k_prune, v, smooth=None, v2=None):
    ...
    # print("masked_attn: ", masked_attn.shape)
...
class DynamicTransformerBlock(nn.Module):
    ...
    def forward(self, q, k, v, pos, seg_map, v2 = None):
        ...
        y = PositionalNorm2d(attn_output + (1 - conf) + q)
